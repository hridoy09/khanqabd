...
<div class="row" style="padding:30px  0px; margin: 0px;">
    ...
    <div class="col-12 col-lg-4 col-md-4" style="text-align: center;">
        ...
        <div class="row " style="justify-content: center;">
            ...
            <iframe id="iframe" title="prayerWidget" class="widget-m-top" style=" height: 300px; " scrolling="no"
                src="https://www.islamicfinder.org/prayer-widget/1205733/shafi/3/0/18.0/18.0"> </iframe>
        </div>
        <!-- mobile app div -->
    ...
    <div class="col-12 col-lg-4 col-md-4" style="text-align: center;    display: flex;
        ...
        <div>
            ...
            <a class="btn btn-md" data-bs-toggle="modal" href="#exampleModalToggle" role="button"><i
                    class="fa-solid fa-calendar-days"></i> SCHEDULE & MAP</a>
        </div>
        ...
        <table style="margin-left: auto; margin-right: auto;">
            <tbody>
                <tr class="contact-tr">
                    ...
                    <td style="text-align left"><a class="contact"
                            href="https://wa.me/{{$contacts->whatsapp_no}}">{{$contacts->whatsapp_no}}</a></td>
                </tr>
                <tr class="contact-tr">
                ...
                <tr class="contact-tr">
                    ...
                    <td style="text-align left"><a class="contact"
                            href="mailto:{{$contacts->gmail}}">{{$contacts->gmail}}</a></td>
                </tr>
            </tbody>
        </table>
    </div>
...
<div class="search-div">
    ...
    <div class="input-group" style="width: 50%;">
        ...
        <div class="input-group-text" style="background-color:#0F5A5A; "><a style="color: white; text-decoration: none;"
                href="">Search</a></div>
    </div>
</div>
    ...
    <div class="slider">
        ...
        <a href="{{asset('admin/book/'.$book->pdf_file)}}" type="application/pdf">
            <div class="slider__item">
                <img src="{{asset('admin/book_feature_img/'.$book->feature_img)}}" alt="">
            </div>
        </a>
...
<div class="row" style="margin: 20px 0px;box-shadow: 0px 0px 10px;
    ...
    <div class="col-12 col-md-6 col-lg-3 audio_list">
        <h5><i class="fa-solid fa-pen-to-square"></i> Documents</h5>

        @forelse ($documents as $document)
        <a href="{{ asset('admin/document/'.$document->document_file) }}" target="_blank" style="border-bottom:1px solid grey; padding-bottom: 5px;">{{ $document->document_file }}</a><a style="float: right;" href=""><i class="fa-solid fa-download"></i></a>
        @empty
            <span>No Document</span>
        @endforelse
        <div style="margin: 30px;">
            <a class="btn btn-success" href="{{ route('document') }}">view More</a>
        </div>
